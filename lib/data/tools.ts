...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    setupComplexity: "Low",
    maturity: "Early",
    clientCompatibility: ["claude-code", "cursor", "chatgpt"],
    memorySupport: "yes",
    maintainedStatus: "actively-maintained",
    bestFor: ["persistent memory", "long-term context", "knowledge graphs"],
    securityNotes: "Local file storage; no external data transmission required",
    selfHosted: true,
    authModel: "None",
  },
  {
  ...
  },
  {
    ...
    shortDescription: "MCP server for Amazon S3 object storage operations",
    description: "MCP server that enables AI agents to interact with AWS S3 buckets. Supports file upload, download, listing, and management through the Model Context Protocol.",
    category: "mcp-server",
    subcategories: ["cloud-storage", "aws"],
    useCases: ["File management", "Data access", "Cloud storage integration"],
    integrations: ["AWS S3", "Claude", "Cursor"],
    pricingModel: "Free",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 12000,
    featured: false,
    lastUpdated: "2025-02-05",
    pros: ["Direct S3 integration", "Secure credential handling", "Scalable"],
    cons: ["Requires AWS credentials", "S3 usage costs", "Complex IAM setup"],
    setupComplexity: "Medium",
    maturity: "Growing",
    clientCompatibility: ["claude-code", "cursor"],
    bestFor: ["file storage access", "data pipelines"],
  },
  {
    slug: "mcp-mongodb",
    name: "MongoDB MCP Server",
    shortDescription: "MCP server for MongoDB database operations",
    description: "MCP server that enables AI agents to query and manipulate MongoDB databases. Supports document operations, aggregations, and schema exploration.",
    category: "mcp-server",
    subcategories: ["database", "nosql"],
    useCases: ["Database queries", "Document operations", "Data analysis"],
    integrations: ["MongoDB", "Claude", "Cursor"],
    pricingModel: "Open Source",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 8000,
    featured: false,
    lastUpdated: "2025-02-01",
    pros: ["NoSQL flexibility", "Easy CRUD operations", "Good error handling"],
    cons: ["Requires MongoDB instance", "Connection management", "Query optimization needed"],
    setupComplexity: "Low",
    maturity: "Growing",
    clientCompatibility: ["claude-code", "cursor", "chatgpt"],
    bestFor: ["NoSQL data access", "document-based workflows"],
  },
  {
    slug: "mcp-twilio",
    name: "Twilio MCP Server",
    shortDescription: "MCP server for SMS and voice communication",
    description: "MCP server that enables AI agents to send SMS messages and make voice calls through Twilio. Supports both messaging and voice APIs.",
    category: "mcp-server",
    subcategories: ["communication", "sms"],
    useCases: ["SMS notifications", "Voice calls", "Customer communication"],
    integrations: ["Twilio", "Claude", "Cursor"],
    pricingModel: "Freemium",
    pricing: "Pay-as-you-go: $0.0075-0.05 per SMS",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 5000,
    featured: false,
    lastUpdated: "2025-01-20",
    pros: ["Easy SMS integration", "Global coverage", "Reliable delivery"],
    cons: ["Usage costs per message", "Rate limits", "Account setup required"],
    setupComplexity: "Low",
    maturity: "Mature",
    clientCompatibility: ["claude-code", "cursor"],
    bestFor: ["notifications", "customer outreach"],
  },
  {
    slug: "mcp-airtable",
    name: "Airtable MCP Server",
    shortDescription: "MCP server for Airtable base operations",
    description: "MCP server that enables AI agents to read and write to Airtable bases. Supports record creation, updates, deletions, and field operations.",
    category: "mcp-server",
    subcategories: ["database", "automation"],
    useCases: ["Database automation", "Record management", "Data synchronization"],
    integrations: ["Airtable", "Claude", "Cursor", "Zapier"],
    pricingModel: "Free",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 6000,
    featured: false,
    lastUpdated: "2025-01-30",
    pros: ["No-code database", "Easy setup", "Built-in views"],
    cons: ["Limited query complexity", "Rate limits", "Export costs"],
    setupComplexity: "Low",
    maturity: "Growing",
    clientCompatibility: ["claude-code", "cursor", "chatgpt"],
    bestFor: ["CRM automation", "content management"],
  },
  {
    slug: "mcp-stripe",
    name: "Stripe MCP Server",
    shortDescription: "MCP server for Stripe payment operations",
    description: "MCP server that enables AI agents to manage Stripe payments, customers, and subscriptions. Supports charge creation, refunds, and customer management.",
    category: "mcp-server",
    subcategories: ["payments", "finance"],
    useCases: ["Payment processing", "Customer management", "Subscription handling"],
    integrations: ["Stripe", "Claude", "Cursor"],
    pricingModel: "Free",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 7000,
    featured: true,
    lastUpdated: "2025-02-10",
    pros: ["Full API coverage", "Secure transaction handling", "Webhook support"],
    cons: ["Requires Stripe account", "PCI compliance needed", "Test mode required first"],
    setupComplexity: "Medium",
    maturity: "Mature",
    clientCompatibility: ["claude-code", "cursor"],
    bestFor: ["payment automation", "billing operations"],
    securityNotes: "Always use restricted API keys; never expose live keys",
  },
  {
    slug: "mcp-openweather",
    name: "OpenWeather MCP Server",
    shortDescription: "MCP server for weather data and forecasts",
    description: "MCP server that enables AI agents to access weather data, forecasts, and climate information through OpenWeather APIs.",
    category: "mcp-server",
    subcategories: ["data", "weather"],
    useCases: ["Weather checks", "Forecast analysis", "Climate data"],
    integrations: ["OpenWeather", "Claude", "Cursor"],
    pricingModel: "Freemium",
    ...
    featured: false,
    lastUpdated: "2025-01-15",
    pros: ["Simple API", "Global coverage", "Free tier available"],
    cons: ["API key required", "Rate limits on free tier", "Limited historical data"],
    setupComplexity: "Low",
    maturity: "Mature",
    clientCompatibility: ["claude-code", "cursor", "chatgpt"],
    bestFor: ["weather-aware workflows", "location intelligence"],
  },
  {
    slug: "mcp-youtube",
    name: "YouTube MCP Server",
    shortDescription: "MCP server for YouTube video and channel operations",
    description: "MCP server that enables AI agents to search YouTube, access video metadata, and manage channel information through the YouTube Data API.",
    category: "mcp-server",
    subcategories: ["media", "video"],
    useCases: ["Video search", "Channel analysis", "Metadata extraction"],
    integrations: ["YouTube", "Claude", "Cursor"],
    pricingModel: "Free",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 4000,
    featured: false,
    lastUpdated: "2025-01-25",
    pros: ["Easy video search", "Rich metadata", "No cost"],
    cons: ["Quota-limited", "Read-only for most operations", "Requires Google account"],
    setupComplexity: "Low",
    maturity: "Growing",
    clientCompatibility: ["claude-code", "cursor"],
    bestFor: ["content research", "video discovery"],
  },
  {
    slug: "mcp-jira",
    name: "Jira MCP Server",
    shortDescription: "MCP server for Jira issue and project management",
    description: "MCP server that enables AI agents to create issues, search tickets, update statuses, and manage Jira projects through the Jira Cloud API.",
    category: "mcp-server",
    subcategories: ["project-management", "developer-tools"],
    useCases: ["Issue creation", "Project tracking", "Automation"],
    integrations: ["Jira", "Claude", "Cursor"],
    pricingModel: "Free",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 9000,
    featured: false,
    lastUpdated: "2025-02-08",
    pros: ["Full issue management", "Custom workflows", "Team visibility"],
    cons: ["Jira license required", "Complex permission model", "API quota limits"],
    setupComplexity: "Medium",
    maturity: "Mature",
    clientCompatibility: ["claude-code", "cursor", "chatgpt"],
    bestFor: ["agile automation", "issue resolution"],
  },
  {
    slug: "mcp-reddit",
    name: "Reddit MCP Server",
    shortDescription: "MCP server for Reddit data and community interaction",
    description: "MCP server that enables AI agents to search Reddit, fetch post data, and analyze community discussions. Read-only access to public content.",
    category: "mcp-server",
    subcategories: ["data", "social"],
    useCases: ["Community research", "Discussion analysis", "Trend monitoring"],
    integrations: ["Reddit API", "Claude", "Cursor"],
    pricingModel: "Free",
    websiteUrl: "https://modelcontextprotocol.io",
    githubUrl: "https://github.com/modelcontextprotocol/servers",
    githubStars: 2500,
    featured: false,
    lastUpdated: "2025-01-20",
    pros: ["Rich community data", "Easy search", "No authentication needed"],
    cons: ["Read-only", "Rate limited", "Removed content not available"],
    setupComplexity: "Low",
    maturity: "Early",
    clientCompatibility: ["claude-code", "cursor"],
    bestFor: ["market research", "community sentiment analysis"],
  },
